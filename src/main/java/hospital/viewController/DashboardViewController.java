...
public class DashboardViewController {
    ...
    public void irACambiarClave() {
        try {
            ...
            CambioClaveViewController cambioClaveViewController = fxmlLoader.getController();
            cambioClaveViewController.setUsuario(Sesion.getUsuario());
            cambioClaveViewController.setLoginController(loginController);
