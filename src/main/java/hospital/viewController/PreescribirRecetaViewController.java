...
import hospital.viewController.busqueda.BuscarPacientePreescripcionViewController;
import hospital.viewController.busqueda.BuscarMedicamentoPreescripcionViewController;
...
public class PreescribirRecetaViewController {
    ...
    private void BuscarPaciente(ActionEvent event) {
        try {
            ...
            BuscarPacientePreescripcionViewController buscarView = loader.getController();
    ...
    private void AgregarReceta(ActionEvent event) {
        ...
        try {
            ...
            Parent root = loader.load();
            BuscarMedicamentoPreescripcionViewController buscarView = loader.getController();
